...
echo "optional_sanitized_wazuh_discover=docs/wiki/assets/wazuh-discover-live-sanitized.png"
echo "optional_sanitized_wazuh_dashboard=docs/wiki/assets/wazuh-dashboard-live-sanitized.png"
echo "optional_sanitized_oci_dashboard=docs/wiki/assets/oci-log-analytics-dashboard-live-sanitized.png"
