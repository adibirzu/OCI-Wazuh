...
required_files=(
  ...
  "docs/wiki/assets/wazuh-threat-hunting-dashboard.png"
  "docs/wiki/assets/wazuh-mitre-dashboard.png"
  "docs/wiki/assets/wazuh-mitre-events.png"
  "docs/wiki/assets/wazuh-pci-dss-dashboard.png"
  "docs/wiki/assets/wazuh-pci-dss-controls.png"
  "docs/wiki/assets/wazuh-pci-dss-events.png"
  "docs/wiki/assets/wazuh-gdpr-dashboard.png"
  "docs/wiki/assets/wazuh-hipaa-dashboard.png"
  "docs/wiki/assets/wazuh-hipaa-controls.png"
  "docs/wiki/assets/wazuh-nist-800-53-dashboard.png"
